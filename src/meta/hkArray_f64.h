...
struct hkArray_f64 hkarray_f64_create(size_t length) {
    struct hkArray_f64 array = {0};
...
void hkarray_f64_destroy(struct hkArray_f64 *array) {
    array->border = 0;
    array->length = 0;
    array->unit_size = 0;
    free(array->data);
...
void *hkarray_f64_resize(struct hkArray_f64 *array, size_t new_border) {
...
void *hkarray_f64_append(struct hkArray_f64 *array, void *elem) {
...
int hkarray_f64_is_empty(struct hkArray_f64 *array) {
