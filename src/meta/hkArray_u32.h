...
struct hkArray_u32 hkarray_u32_create(size_t length) {
    struct hkArray_u32 array = {0};
...
void hkarray_u32_destroy(struct hkArray_u32 *array) {
    array->border = 0;
    array->length = 0;
    array->unit_size = 0;
    free(array->data);
...
void *hkarray_u32_resize(struct hkArray_u32 *array, size_t new_border) {
...
void *hkarray_u32_append(struct hkArray_u32 *array, void *elem) {
...
int hkarray_u32_is_empty(struct hkArray_u32 *array) {
