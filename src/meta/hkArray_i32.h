...
struct hkArray_i32 hkArray_i32_create(size_t length) {
    struct hkArray_i32 array = {0};
...
void hkArray_i32_destroy(struct hkArray_i32 *array) {
    array->border = 0;
    array->length = 0;
    array->unit_size = 0;
    free(array->data);
...
void *hkArray_i32_resize(struct hkArray_i32 *array, size_t new_border) {
...
void *hkArray_i32_append(struct hkArray_i32 *array, void *elem) {
...
int hkArray_i32_is_empty(struct hkArray_i32 *array) {
