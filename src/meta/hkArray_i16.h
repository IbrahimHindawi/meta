...
struct hkArray_i16 hkarray_i16_create(size_t length) {
    struct hkArray_i16 array = {0};
...
void hkarray_i16_destroy(struct hkArray_i16 *array) {
    array->border = 0;
    array->length = 0;
    array->unit_size = 0;
    free(array->data);
...
void *hkarray_i16_resize(struct hkArray_i16 *array, size_t new_border) {
...
void *hkarray_i16_append(struct hkArray_i16 *array, void *elem) {
...
int hkarray_i16_is_empty(struct hkArray_i16 *array) {
